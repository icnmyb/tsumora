    ...
    rules: [
      {
        ...
        values: { kuitan:"あり", ippatsu:"なし", uradora:"なし", kandora:"なし", akadora:"なし", kuikae:"なし", tochuu:"なし", agariyame:"なし", points:"30000/30000", rankpts:"+8〜+12", chombo:"▲20pt" },
      },
      {
        id: "jpml-wrc", org: "JPML", name: "WRCルール",
        description: "世界大会標準。一発・裏ドラあり",
        values: { kuitan:"あり", ippatsu:"あり", uradora:"あり", kandora:"あり", akadora:"なし", kuikae:"なし", tochuu:"なし", agariyame:"なし", points:"30000/30000", rankpts:"+15", chombo:"▲30pt" },
      },
      {
        id: "jpml-wrcr", org: "JPML", name: "WRC-Rルール",
        description: "WRCに赤牌・高順位点を追加",
        values: { kuitan:"あり", ippatsu:"あり", uradora:"あり", kandora:"あり", akadora:"あり（各1枚）", kuikae:"なし", tochuu:"なし", agariyame:"なし", points:"30000/30000", rankpts:"+30", chombo:"▲30pt" },
      },
    ],
  },
  {
    ...
    rules: [
      {
        ...
        values: { kuitan:"あり", ippatsu:"あり", uradora:"あり", kandora:"あり", akadora:"なし", kuikae:"なし", tochuu:"なし", agariyame:"—", points:"25000/30000", rankpts:"—", chombo:"—" },
      },
    ],
  },
  {
    ...
    rules: [
      {
        ...
        values: { kuitan:"あり", ippatsu:"あり", uradora:"あり", kandora:"あり", akadora:"なし", kuikae:"なし", tochuu:"なし", agariyame:"—", points:"30000/30000", rankpts:"—", chombo:"—" },
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: { kuitan:"あり", ippatsu:"なし", uradora:"なし", kandora:"なし", akadora:"なし", kuikae:"なし", tochuu:"なし", agariyame:"—", points:"30000/30000", rankpts:"—", chombo:"—" },
      },
      {
        id: "rmu-m", org: "RMU", name: "Mルール",
        description: "Mリーグ採用ルール",
        values: { kuitan:"あり", ippatsu:"あり", uradora:"あり", kandora:"あり", akadora:"あり", kuikae:"なし", tochuu:"なし", agariyame:"—", points:"25000/30000", rankpts:"—", chombo:"—" },
      },
    ],
  },
  {
