...
export const NEWS: NewsArticle[] = [
  ...
  },
  {
    ...
    lead:
      "Mリーグ 2025-26セミファイナルが終了。BEAST X、EX風林火山、TEAM RAIDEN/雷電、KONAMI麻雀格闘倶楽部がファイナルへ進出した。",
    body: [
      "Mリーグ 2025-26 シーズンのセミファイナルは全30試合を終了。BEAST X、EX風林火山、TEAM RAIDEN/雷電、KONAMI麻雀格闘倶楽部の4チームがファイナル進出を決めた。",
      "ファイナルは5月4日開幕予定。セミファイナルを首位通過したBEAST Xを、風林火山・雷電・KONAMIが追う構図で最終決戦に入る。",
    ],
  },
];
