...
export const NEWS: NewsArticle[] = [
  ...
  },
  {
    ...
    date: "2026-04",
    category: "mleague",
    headline: "Mリーグ 2025-26 シーズン、レギュラー終盤に",
    lead:
      "10月開幕のMリーグ 2025-26レギュラーシーズンが終盤戦に突入。セミファイナル進出の上位6チーム争いが過熱している。",
    body: [
      "Mリーグ 2025-26 シーズンはレギュラーシーズン終盤戦。全10チームによる長期リーグ戦は5月初旬の決着に向けて佳境に入っている。",
      "上位6チームがセミファイナル、上位4チームがファイナルに進出するレギュレーションのもと、各チーム残り試合数が少なくなる中で1試合の重みが増している。",
    ],
  },
];
