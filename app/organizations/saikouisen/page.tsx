...
const SAIKOUISEN: OrgDetailPageData = {
  ...
  roster: {
    ...
    rows: [
      { rk: "一", top3: true, avatar: "石", avatarClass: "vermilion", name: "石井 一馬", href: "/players/ishii", sub: "1986生 · 第28期入会 · 第49期最高位 · EARTH JETS", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "最高位" }, { kind: "plain", label: "Classic×2" }, { kind: "plain", label: "蒼翼戦×2" }, { kind: "plain", label: "王位" }] },
      { rk: "二", top3: true, avatar: "鈴", name: "鈴木 優", href: "/players/suzuki-y", sub: "1981生 · 第36期入会 · 第46期最高位 · U-NEXT Pirates", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "最高位" }, { kind: "plain", label: "麻雀日本シリーズ×2" }] },
      { rk: "三", top3: true, avatar: "園", avatarClass: "gold", name: "園田 賢", href: "/players/sonoda", sub: "1981生 · 第27期入会 · 赤坂ドリブンズ", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "最強位" }, { kind: "plain", label: "RTDリーグ" }] },
      { rk: "四", avatar: "村", name: "村上 淳", sub: "1976生 · 第19期入会 · 第3期最高位 · 連覇記録保持者", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "最高位" }] },
      { rk: "五", avatar: "た", avatarClass: "moss", name: "鈴木 たろう", href: "/players/suzuki-t", sub: "1972生 · 第19期入会 · 赤坂ドリブンズ", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "最高位×2" }, { kind: "plain", label: "發王×2" }] },
      { rk: "六", avatar: "竹", name: "竹内 元太", href: "/players/takeuchi", sub: "1986生 · 第31期入会 · KADOKAWAサクラナイツ", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "最高位" }] },
      { rk: "七", avatar: "日", avatarClass: "vermilion", name: "日向 藍子", href: "/players/hinata", sub: "1985生 · 第33期入会 · 渋谷ABEMAS · 女流の実力派", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "Classic" }, { kind: "plain", label: "女流最高位" }] },
      { rk: "八", avatar: "醍", avatarClass: "moss", name: "醍醐 大", href: "/players/daigo", sub: "1989生 · 第36期入会 · セガサミーフェニックス", league: "A2", leagueClass: "a2", titles: [{ kind: "primary", label: "Classic" }] },
      { rk: "九", avatar: "渡", name: "渡辺 太", href: "/players/watanabe", sub: "1988生 · 第33期入会 · 第48期最高位", league: "A2", leagueClass: "a2", titles: [{ kind: "primary", label: "最高位" }] },
      { rk: "十", avatar: "渋", name: "渋川 難波", href: "/players/shibukawa", sub: "1985生 · 2026年協会から移籍 · KADOKAWAサクラナイツ", league: "A2", leagueClass: "a2", titles: [{ kind: "primary", label: "雀竜位×2" }, { kind: "plain", label: "雀王戦Aリーグ通算" }] },
    ],
  },
  milestones: [
