...
const MU: OrgDetailPageData = {
  ...
  meta: [
    ...
    { label: "Active Pros", value: "88", unit: "名", sub: "公式HP掲載数" },
  ...
  info: [
    ...
    { dt: "代表", dd: "忍田 幸夫" },
    { dt: "掲載プロ", dd: "88名 (公式HP掲載数)" },
    { dt: "本部", dd: "東京都" },
    { dt: "理念", dd: "金銭を賭けない競技としての麻将" },
    { dt: "主要公式戦", dd: "μリーグ（将王）· ツアーランキング戦（将星） · 将妃戦 · BIG1カップ" },
  ...
  milestones: [
    ...
    { year: "2018", kind: "Mリーグ", title: "Mリーグ参戦", desc: "麻将連合所属プロがMリーグ初年度から参戦。" },
  ],
  champions: {
    title: "歴代将王",
    en: "Past Shōō",
