...
const NPM: OrgDetailPageData = {
  ...
  titles: {
    ...
    cards: [
      ...
      },
      {
        ...
        since: "入会5年以内 / 雀王戦Aリーグ未経験プロ対象",
        leaderName: "現新人王：梅岡 泰己",
        leaderPt: "第25期",
        leaderPtDone: true,
      },
      {
      ...
      },
      {
        ...
        title: "日本オープン",
        en: "Japan Open",
        since: "プロアマ混合オープンタイトル",
        leaderName: "現覇者：岩崎 啓悟",
        leaderPt: "第22回",
        leaderPtDone: true,
      },
      {
  ...
  roster: {
    ...
    rows: [
      { rk: "一", top3: true, avatar: "仲", avatarClass: "vermilion", name: "仲林 圭", href: "/players/nakabayashi", sub: "1985生 · 第7期入会 · 第23期雀王 · U-NEXT Pirates", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "雀王×2" }, { kind: "plain", label: "發王位×2" }, { kind: "plain", label: "雀竜位" }] },
      { rk: "二", top3: true, avatar: "浅", name: "浅井 堂岐", href: "/players/asai", sub: "1985生 · 第6期入会 · 第10期雀竜位 · セガサミーフェニックス", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "雀竜位" }] },
      { rk: "三", top3: true, avatar: "松", avatarClass: "gold", name: "松本 吉弘", href: "/players/matsumoto", sub: "1980生 · 第3期入会 · KADOKAWAサクラナイツ", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "雀王" }] },
      { rk: "四", avatar: "下", name: "下石 戟", href: "/players/shimoishi", sub: "1989生 · 第13期入会 · BEAST X", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "雀王" }] },
      { rk: "五", avatar: "茨", name: "茨城 啓太", sub: "1990生 · 第14期入会 · A1リーグ常連", league: "A1", leagueClass: "a1", titles: [{ kind: "plain", label: "Aリーグ通算" }] },
      { rk: "六", avatar: "石", name: "石橋 伸洋", sub: "1978生 · 第3期入会 · 防御型の名手", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "雀王×2" }] },
      { rk: "七", avatar: "千", avatarClass: "moss", name: "千貫 陽祐", sub: "1986生 · 第10期入会 · 第19期雀王", league: "A1", leagueClass: "a1", titles: [{ kind: "primary", label: "雀王" }] },
      { rk: "八", avatar: "矢", name: "矢島 亨", sub: "1981生 · 第5期入会 · A1リーグ常連 · 現役", league: "A1", leagueClass: "a1", titles: [{ kind: "plain", label: "Aリーグ通算" }] },
      { rk: "九", avatar: "逢", avatarClass: "vermilion", name: "逢川 恵夢", href: "/players/aikawa", sub: "1987生 · 第10期入会 · 永世女流雀王 · EARTH JETS", league: "B2", leagueClass: "b", titles: [{ kind: "primary", label: "永世女流雀王" }, { kind: "plain", label: "女流名人" }] },
      { rk: "十", avatar: "鈴", avatarClass: "gold", name: "鈴木 ケンタ", sub: "1986生 · 第10期入会 · A1リーグ常連", league: "A1", leagueClass: "a1", titles: [{ kind: "plain", label: "新人王" }] },
    ],
  },
  milestones: [
