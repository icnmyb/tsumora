...
export const TITLES: TitleData[] = [
  {
    ...
    pastChampions: [
      { ep: "42", year: "2025", name: "白鳥 翔", href: "/players/shiratori", current: true },
      { ep: "41", year: "2024", name: "白鳥 翔", href: "/players/shiratori" },
      { ep: "40", year: "2023", name: "佐々木 寿人", href: "/players/sasaki" },
      { ep: "39", year: "2022", name: "HIRO柴田", href: "/players/hiro-shibata" },
      { ep: "38", year: "2021", name: "佐々木 寿人", href: "/players/sasaki" },
      { ep: "37", year: "2020", name: "佐々木 寿人", href: "/players/sasaki" },
      { ep: "36", year: "2019", name: "藤崎 智" },
      { ep: "35", year: "2018", name: "吉田 直" },
      { ep: "34", year: "2017", name: "前原 雄大" },
  ...
  },
  {
    ...
    pastChampions: [
      ...
      { ep: "39", year: "2022", name: "魚谷 侑未" },
      { ep: "38", year: "2021", name: "荒 正義" },
      { ep: "37", year: "2020", name: "柴田 吉和" },
  ...
  },
  {
    ...
    pastChampions: [
      { ep: "50", year: "2025", name: "石川 正明", current: true },
      { ep: "49", year: "2024", name: "福島 佑一" },
      { ep: "48", year: "2023", name: "三浦 智博", href: "/players/miura" },
      { ep: "47", year: "2022", name: "石井 良樹" },
      { ep: "46", year: "2021", name: "渡辺 史哉" },
      { ep: "45", year: "2019", name: "森下 剛任" },
      { ep: "44", year: "2018", name: "魚谷 侑未" },
      { ep: "43", year: "2017", name: "野方 祐介" },
  ...
  },
  {
    ...
    pastChampions: [
      ...
      { ep: "23", year: "2024", name: "逢川 恵夢", href: "/players/aikawa" },
      { ep: "22", year: "2023", name: "逢川 恵夢", href: "/players/aikawa" },
      { ep: "21", year: "2022", name: "水崎 ともみ" },
      { ep: "20", year: "2021", name: "逢川 恵夢", href: "/players/aikawa" },
      { ep: "19", year: "2020", name: "佐月 麻理子" },
      { ep: "18", year: "2019", name: "逢川 恵夢", href: "/players/aikawa" },
      { ep: "17", year: "2018", name: "逢川 恵夢", href: "/players/aikawa" },
      { ep: "16", year: "2017", name: "朝倉 ゆかり" },
      { ep: "15", year: "2016", name: "朝倉 ゆかり" },
      { ep: "14", year: "2015", name: "佐月 麻理子" },
      { ep: "13", year: "2014", name: "豊後 葵" },
      { ep: "12", year: "2013", name: "大崎 初音" },
      { ep: "11", year: "2012", name: "冨本 智美" },
      { ep: "10", year: "2011", name: "大崎 初音" },
      { ep: "9", year: "2010", name: "大崎 初音" },
      { ep: "8", year: "2009", name: "朝倉 ゆかり" },
      { ep: "7", year: "2008", name: "朝倉 ゆかり" },
      { ep: "6", year: "2007", name: "崎見 百合" },
      { ep: "5", year: "2006", name: "眞崎 雪菜" },
      { ep: "4", year: "2005", name: "眞崎 雪菜" },
      { ep: "3", year: "2004", name: "崎見 百合" },
      { ep: "2", year: "2003", name: "奥村 知美" },
      { ep: "1", year: "2002", name: "手塚 紗掬" },
    ],
    relatedTitles: [
      { slug: "jakuou-isen", name: "雀王戦" },
      { slug: "jaryuui-sen", name: "雀竜位戦" },
  ...
  },
  {
    ...
    holder: { name: "牧野 伸彦", note: "第50期 (2026)" },
    season: "年間リーグ戦",
    ...
    pastChampions: [
      { ep: "50", year: "2026", name: "牧野 伸彦", current: true },
      { ep: "49", year: "2025", name: "石井 一馬", href: "/players/ishii" },
  ...
  },
  {
    ...
    orgLabel: "Real Mahjong Unit",
    orgHref: "/organizations/rmu",
    holder: { name: "金宮 じゅん", note: "第10期 (2024)" },
    season: "女流アスリートリーグ",
    tags: ["RMU", "女流", "リーグ戦"],
    founded: 2015,
    ...
    pastChampions: [
      { ep: "10", year: "2024", name: "金宮 じゅん", current: true },
      { ep: "9", year: "2023", name: "里中 花奈" },
      { ep: "8", year: "2022", name: "千本松 紘子" },
      { ep: "7", year: "2021", name: "汐宮 あまね" },
      { ep: "6", year: "2020", name: "新倉 美紀" },
      { ep: "5", year: "2019", name: "白田 みお" },
      { ep: "4", year: "2018", name: "里中 花奈" },
      { ep: "3", year: "2017", name: "京杜 なお" },
      { ep: "2", year: "2016", name: "南地 祐圭" },
      { ep: "1", year: "2015", name: "白田 みお" },
    ],
    relatedTitles: [
      { slug: "reishouisen", name: "令昭位戦" },
      { slug: "rmu-crown", name: "RMUクラウン" },
  ...
  },
  {
    ...
    pastChampions: [
      ...
      { ep: "25", year: "2022", name: "竹内 元太", href: "/players/takeuchi" },
      { ep: "24", year: "2021", name: "山崎 淑弥" },
      { ep: "23", year: "2020", name: "醍醐 大", href: "/players/daigo" },
