...
export const TITLES: TitleData[] = [
  ...
  // ── 8. 将王戦 (MU 麻将連合-μ-) ────────────────────────────
  {
    ...
    holder: { name: "忍田 幸夫", note: "第21期 (2025) 5度目戴冠" },
    season: "通年 · 短期決戦 + 防衛戦",
    tags: ["μ最高峰", "短期決戦", "純競技ルール"],
    founded: 1999,
    formatLabel: "認定プロ上位10名による短期決戦 + 防衛戦",
    about: [
      "将王戦は麻将連合-μ- (MU) が主催する団体最高峰のタイトル戦。1999年創設で、認定プロ上位10名による短期決戦で年に一度の将王を決める。",
      "純競技ルール (一発・裏ドラ・赤牌なし) を採用し、技術勝負の色合いが強い。第14期 (2018) で初戴冠した忍田幸夫が、その後第16・18・20・21期と通算5度の戴冠を果たし長く君臨している。",
      "Mリーガー (U-NEXT Pirates) の小林剛も第13・15・19期で3度の将王経験者。μ の純競技理念を体現する論理派として知られる。",
    ],
    rules: [
      { label: "ルール", value: "μ純競技ルール" },
      { label: "持ち点", value: "30,000" },
      { label: "オカ", value: "あり" },
      { label: "ウマ", value: "10-20" },
      { label: "赤牌", value: "なし" },
      { label: "一発・裏ドラ", value: "なし" },
      { label: "対象", value: "認定プロ上位10名" },
      { label: "形式", value: "短期決戦 + 防衛戦" },
    ],
    pastChampions: [
      { ep: "22", year: "2026", name: "忍田 幸夫", note: "防衛戦進行中", current: true },
      { ep: "21", year: "2025", name: "忍田 幸夫", note: "5度目戴冠" },
      { ep: "20", year: "2024", name: "忍田 幸夫", note: "4度目" },
      { ep: "19", year: "2023", name: "小林 剛", href: "/players/kobayashi", note: "Mリーガー" },
      { ep: "18", year: "2022", name: "忍田 幸夫", note: "3度目" },
      { ep: "17", year: "2021", name: "須田 良規" },
      { ep: "16", year: "2020", name: "忍田 幸夫", note: "2度目" },
      { ep: "15", year: "2019", name: "小林 剛", href: "/players/kobayashi", note: "Mリーガー" },
      { ep: "14", year: "2018", name: "忍田 幸夫", note: "初戴冠" },
      { ep: "13", year: "2017", name: "小林 剛", href: "/players/kobayashi" },
      { ep: "12", year: "2016", name: "須田 良規" },
    ],
    relatedTitles: [
      { slug: "houou-isen", name: "鳳凰位戦" },
      { slug: "saikouisen", name: "最高位戦" },
