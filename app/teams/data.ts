...
export const TEAMS: TeamData[] = [
  ...
  // ── 5. セガサミーフェニックス ──────────────────────────────
  {
    ...
    about: [
      ...
      "2024-25シーズンに大規模な世代交代を経て、醍醐大 (最高位戦・2023年加入)、竹内元太 (最高位戦・2024年加入)、浅井堂岐 (協会・2024年加入) と、創設以来唯一残った茅森早香で構成された新生フェニックスが頂点を獲った。2026年ドラフトでは佐野ひなこを指名した。",
    ],
    currentRoster: [
  ...
  // ── 6. TEAM RAIDEN / 雷電 ──────────────────────────────
  {
    ...
    about: [
      ...
      "Mリーグ通算でファイナル進出は3回 (2022-23・2024-25・2025-26)、優勝は未経験。攻撃型「全部和了る」スタイルが代名詞で、爆発力と粘り強さの振れ幅が大きいチーム。",
    ],
    currentRoster: [
    ...
    milestones: [
      ...
      { year: "2026", kind: "進出", title: "Mリーグ2025-26 ファイナル進出", desc: "3度目のファイナル進出 (3位)。セミファイナルを突破し、2年連続で最終決戦へ進んだ。" },
    ],
    championships: 0,
    finalAppearances: 3,
    social: [
  ...
  // ── 7. U-NEXT Pirates ──────────────────────────────
  {
    ...
    about: [
      ...
      "Mリーグ史上唯一の2回優勝チーム (2019-20, 2023-24)。小林剛 (μ) を中心にした初期編成から、瑞原明奈 (最高位戦)・鈴木優 (最高位戦)・仲林圭 (協会) を加えて2度目の優勝を果たした。",
      "2021-22シーズンに瑞原明奈が女性初のMリーグMVPを獲得、2023-24シーズンには鈴木優がMVPに輝きチームを2度目の優勝に導いた。創設メンバーの朝倉康心・石橋伸洋は2021-22シーズン後に退団、2022年のドラフトで鈴木優・仲林圭が加入し「シン・パイレーツ」として再出発した。2026年ドラフトでは朝倉康心を再指名した。",
    ...
    pastMembers: [
      { name: "朝倉 康心", years: "2018-2022", note: "創設メンバー、2021-22シーズン後に契約満了。2026年ドラフトで再加入" },
  ...
  // ── 8. KADOKAWAサクラナイツ ─────────────────────────────
  {
    ...
    about: [
      ...
      "所属プロは多団体に渡り、岡田紗佳 (連盟)、堀慎吾 (協会→2026年連盟移籍)、阿久津翔太 (連盟)、尻無濱航 (協会) という構成。岡田紗佳はモデル・タレントとしても活動するMリーグ広報の象徴的存在。",
      "2024-25シーズンを最終順位7位で終え、チーム創設以来初めてセミファイナル進出を逃した。オフに内川幸太郎 (現EX風林火山) との契約満了を発表し、2025年ドラフトで阿久津翔太を指名。2026年ドラフトでは尻無濱航を指名した。",
    ],
    currentRoster: [
      { id: "okada", role: "モデル兼業" },
      { id: "hori", role: "元雀王" },
    ...
    pastMembers: [
      ...
      { name: "渋川 難波", years: "2022-2026", note: "2022年加入、2025-26シーズン後に退団" },
    ],
    seasons: [
  ...
  // ── 9. BEAST X ──────────────────────────────
  {
    ...
    about: [
      ...
      "創設メンバーは鈴木大介 (連盟)・中田花奈 (連盟)・猿川真寿 (協会)・菅原千瑛 (連盟) の4名。鈴木大介は現役の将棋棋士でもあり、二刀流での活動が異色の存在。中田花奈は乃木坂46を卒業後にプロ入りという経歴で、Mリーグの女流ファン拡大に貢献している。",
