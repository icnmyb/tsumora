...
export const ALL_PLAYERS: AllPlayer[] = [
  ...
  // ── KONAMI麻雀格闘倶楽部 ────────────────────────────────────
  { id: "sasaki", name: "佐々木寿人", nameEn: "Toshihito Sasaki", org: "JPML", title: "鳳凰位×3", tags: ["攻撃型", "A1"], league: "A1", period: "第19期", joinYear: 2003, birthday: "1979/08/01", gender: "male", href: "/players/sasaki", mleagueTeam: "KONAMI麻雀格闘倶楽部", birthplace: "宮城県仙台市", bloodType: "O型", hobby: "桃鉄", nickname: "麻雀攻めダルマ", titles: [{ year: "2023", name: "第40期鳳凰位" }, { year: "2021", name: "第38期鳳凰位" }, { year: "2020", name: "第37期鳳凰位" }, { year: "2020", name: "麻雀日本シリーズ2020" }, { year: "2018", name: "麻雀日本シリーズ2018" }, { year: "2017", name: "第7期麻雀グランプリMAX" }, { year: "2020-21", name: "Mリーグ2020-21 MVP" }], bio: ["「戦闘民族」佐々木寿人。宮城県仙台市出身、1977年生まれ。東北学院大学中退後、2003年に日本プロ麻雀連盟第19期生としてプロ入り。", "どこまでも押し続ける超攻撃型の雀風から「戦闘民族」と称される。十段位を5期以上、麻雀マスターズを複数期獲得するなど連盟トップクラスのタイトルホルダー。Mリーグには2018年発足時からKONAMI麻雀格闘倶楽部のメンバー。", "趣味は桃鉄（桃太郎電鉄）。「放銃を恐れない」スタイルでファンからは愛されており、Mリーグでも常に上位の人気を誇る。"], annualPoints: [{ season: "2018-19", points: 228.3, note: "final" }, { season: "2019-20", points: 80.7, note: "semifinal" }, { season: "2020-21", points: 494.1, note: "semifinal" }, { season: "2021-22", points: -77.3, note: "final" }, { season: "2022-23", points: 213.3, note: "final" }, { season: "2023-24", points: 16.3, note: "semifinal" }, { season: "2024-25", points: 388.0, note: "semifinal" }, { season: "2025-26", points: 11.1 }], currentSeason: { season: "2025-26", topRate: 20, avoid4th: 73, bestScore: 74400 }, videos: [
  ...
  { id: "nagai", name: "永井孝典", nameEn: "Kosuke Nagai", org: "最高位戦", title: "", tags: ["A"], league: "C3", period: "", joinYear: 2008, birthday: "1986/08/10", gender: "male", href: "/players/nagai", mleagueTeam: "EX風林火山", birthplace: "愛知県田原市", bloodType: "B型", hobby: "競馬・野球観戦", nickname: "三河の猛将", bio: ["「フッ軽雀士」永井孝典。愛知県田原市出身、1986年生まれ。最高位戦日本プロ麻雀協会所属。関西を拠点にしながら全国のタイトル戦予選やプロアマ大会に積極参加する行動力が持ち味。", "Mリーグには2024-25シーズンよりEX風林火山のメンバーとして参加。加入直後からトップを量産し、チームの勝利に大きく貢献した。", "趣味は競馬と野球観戦。隣の豊橋市出身の鈴木優選手と同じ高校の先輩にあたるという縁も。"], annualPoints: [{ season: "2025-26", points: 503.6 }], currentSeason: { season: "2025-26", topRate: 41, avoid4th: 85, bestScore: 67100 }, videos: [
  ...
  { id: "uchikawa", name: "内川幸太郎", nameEn: "Kotaro Uchikawa", org: "JPML", title: "十段位", tags: ["A1"], league: "A1", period: "第21期", joinYear: 2005, birthday: "1981/05/06", gender: "male", href: "/players/uchikawa", mleagueTeam: "EX風林火山", birthplace: "長野県松本市", bloodType: "O型", hobby: "ポーカー", nickname: "手順マエストロ", titles: [{ year: "2025", name: "第4回リーチ麻雀世界選手権" }, { year: "2023", name: "第1期紅龍戦" }, { year: "2018", name: "第35期十段位" }], bio: ["「手順マエストロ」内川幸太郎。長野県松本市出身、1981年生まれ。長野県松本深志高校卒業後、21歳で雀荘経営を決意し経営者として活動。その後2005年に日本プロ麻雀連盟第21期生としてプロ入り。", "十段位を2期連覇（第35・36期）するなどタイトルを複数獲得。正確な手順と読みの深さが特徴で「手順マエストロ」と称される。KADOKAWAサクラナイツに2018年発足時から参加し、2024-25シーズンからEX風林火山に移籍。", "趣味はポーカー。論理的な思考を麻雀に活かし、チームの中核として長年活躍してきた。"], annualPoints: [{ season: "2019-20", points: -33.1, note: "final" }, { season: "2020-21", points: 468.7, note: "final" }, { season: "2021-22", points: -139.7, note: "final" }, { season: "2022-23", points: 151.1, note: "semifinal" }, { season: "2023-24", points: -204.8, note: "final" }, { season: "2024-25", points: -56.6 }, { season: "2025-26", points: 320.4 }], currentSeason: { season: "2025-26", topRate: 33, avoid4th: 83, bestScore: 104700 }, videos: [
  ...
  // ── BEAST X ─────────────────────────────────────────────────
  { id: "suzuki-d", name: "鈴木大介", nameEn: "Daisuke Suzuki", org: "JPML", title: "最強位", tags: ["棋士", "A1"], league: "A1", period: "第10期", joinYear: 1994, birthday: "1974/07/11", gender: "male", href: "/players/suzuki-d", mleagueTeam: "BEAST X", birthplace: "東京都町田市", bloodType: "A型", hobby: "競馬・囲碁・ゴルフ", nickname: "二刀流ブルドーザー", titles: [{ year: "2019", name: "麻雀最強戦2019 最強位" }], bio: ["「二刀流ブルドーザー」鈴木大介。東京都町田市出身、1974年生まれ。将棋棋士（棋士番号213・九段）として長年活躍し、2023年に日本プロ麻雀連盟に入会した史上初の将棋・麻雀二刀流プロ。", "将棋では1994年に20歳でプロ棋士となり、2023年に将棋の最高段位・九段に昇段。同年Mリーグドラフト会議でBEAST Xに指名され、麻雀プロとしてのMリーグデビューも果たした。", "趣味は競馬・囲碁・ゴルフ。知性と経験が凝縮されたオーラで、二つのトップを極めた唯一の存在として注目を集め続けている。"], annualPoints: [{ season: "2023-24", points: -97.2 }, { season: "2024-25", points: 30.0 }, { season: "2025-26", points: -159.3 }], currentSeason: { season: "2025-26", topRate: 18, avoid4th: 66, bestScore: 58600 }, videos: [
  ...
  { id: "shimoishi", name: "下石戟", nameEn: "Geki Shimoishi", org: "NPM", title: "RMUクラウン", tags: ["攻撃型"], league: "A1", period: "第13期", joinYear: 2014, birthday: "1987/03/20", gender: "male", href: "/players/shimoishi", mleagueTeam: "BEAST X", birthplace: "北海道苫小牧市", bloodType: "B型", hobby: "ビールを飲むこと", nickname: "鬼神", titles: [{ year: "2025-26", name: "Mリーグ2025-26 MVP" }, { year: "2023", name: "第15期RMUクラウン" }], bio: ["「逆襲の戟」下石戟。北海道苫小牧市出身、1987年生まれ。日本プロ麻雀協会第13期生（旧名：下井重貴）。2025-26シーズンに行われたBEAST Xのメンバー入替オーディションで優勝し、ドラフト指名を勝ち取った。", "Mリーグには2025-26シーズンよりBEAST Xのメンバーとして参加。オーディションでは全国のプロ雀士と競い合い、その実力を証明した。協会の雀王戦にも参加し着実にキャリアを積んでいる。", "趣味はビールを飲むこと。北海道出身らしい豪快さと、緻密な読みを両立させた雀風が持ち味。"], annualPoints: [{ season: "2025-26", points: 614.0 }], currentSeason: { season: "2025-26", topRate: 36, avoid4th: 84, bestScore: 58000 }, videos: [
  ...
  { id: "daigo", name: "醍醐大", nameEn: "Dai Daigo", org: "最高位戦", title: "最高位", tags: ["A"], league: "A2", period: "", joinYear: 2010, birthday: "1988/06/14", gender: "male", href: "/players/daigo", mleagueTeam: "セガサミーフェニックス", birthplace: "千葉県松戸市", bloodType: "O型", hobby: "将棋・人狼・サウナ", nickname: "孤高の探究者", titles: [{ year: "2024-25", name: "Mリーグ2024-25 個人MVP" }, { year: "2020", name: "第45期最高位" }, { year: "2020", name: "第23回BIG1カップ" }], bio: ["「孤高の探究者」「先切り十段」醍醐大。千葉県松戸市出身、1976年生まれ。慶應義塾大学経済学部退学後、最高位戦日本プロ麻雀協会に入会（第30期前期）。中学から慶應に通った高学歴雀士。", "2020年に第45期最高位を獲得。「先切り十段」の異名が示すように、バランス型でありながら独自の読みで牌を先切りするスタイルが持ち味。Mリーグには2020-21シーズンよりセガサミーフェニックスのメンバーとして参加。", "趣味は将棋・人狼・サウナ。サラリーマン兼Mリーガーという二刀流で、川に落ちて足を骨折したエピソードも伝説。"], annualPoints: [{ season: "2023-24", points: -214.4 }, { season: "2024-25", points: 438.6, note: "semifinal" }, { season: "2025-26", points: 113.0 }], currentSeason: { season: "2025-26", topRate: 29, avoid4th: 75, bestScore: 60500 }, videos: [
  ...
  { id: "suzuki-y", name: "鈴木優", nameEn: "Yu Suzuki", org: "最高位戦", title: "最高位", tags: ["A"], league: "Aリーグ", period: "第36期", joinYear: 2017, birthday: "1981/09/13", gender: "male", href: "/players/suzuki-y", mleagueTeam: "U-NEXT Pirates", birthplace: "愛知県豊橋市", bloodType: "O型", hobby: "お酒・カラオケ", nickname: "戦闘民族", titles: [{ year: "2024", name: "麻雀日本シリーズ2024" }, { year: "2023-24", name: "Mリーグ2023-24 MVP" }, { year: "2022", name: "麻雀日本シリーズ2022" }, { year: "2021", name: "第46期最高位" }], bio: ["「最強戦の申し子」鈴木優。愛知県豊橋市出身、1981年生まれ。地元大学中退後、雀荘経営を経て最高位戦日本プロ麻雀協会に入会（第36期前期）。地元に「マナーの良い雀荘を作りたい」という思いから雀荘を立ち上げた実業家でもある。", "麻雀最強戦で特に強さを発揮し「最強戦の申し子」と称される。U-NEXT Piratesのメンバーとして2022-23シーズンより参加 (2022年7月ドラフトで仲林圭と同時契約、「シン・パイレーツ」として再出航)。安定した成績でチームに貢献し続けている。", "趣味はお酒とカラオケ。愛知県豊橋市から全国区の舞台へ飛び出した地方発のMリーガーとして、地元ファンからも熱い支持を受けている。"], annualPoints: [{ season: "2022-23", points: -92.8, note: "semifinal" }, { season: "2023-24", points: 437.7, note: "final" }, { season: "2024-25", points: 180.8, note: "final" }, { season: "2025-26", points: 114.8 }], currentSeason: { season: "2025-26", topRate: 29, avoid4th: 67, bestScore: 91500 }, videos: [
  ...
  // ── EARTH JETS ──────────────────────────────────────────────
  { id: "ishii", name: "石井一馬", nameEn: "Kazuma Ishii", org: "最高位戦", title: "最高位", tags: ["A"], league: "A1", period: "", joinYear: 2006, birthday: "1986/02/21", gender: "male", href: "/players/ishii", mleagueTeam: "EARTH JETS", birthplace: "東京都", bloodType: "A型", hobby: "ゲーム", nickname: "トリプルクラウン", titles: [{ year: "2026", name: "第2期蒼翼戦" }, { year: "2025", name: "第1期蒼翼戦" }, { year: "2025", name: "第49期最高位" }, { year: "2024", name: "第18期飯田正人杯最高位戦Classic" }, { year: "2015", name: "第41期王位" }, { year: "2015", name: "第10期飯田正人杯最高位戦Classic" }, { year: "2012", name: "第21期麻雀マスターズ" }], bio: ["「データ派の刺客」石井一馬。東京都出身、1986年生まれ。2006年、19歳で最高位戦日本プロ麻雀協会に入会。中学生から麻雀データ分析に取り組んできた理論派。", "2024年に第49期最高位を獲得。速く鋭い攻撃を武器に20代から数々のビッグタイトルで上位進出を続け、Mリーグには2025-26シーズンよりEARTH JETSメンバーとして参加。", "趣味はゲーム。データと感覚を融合させた独自の雀風でMリーグでも存在感を発揮している。"], annualPoints: [{ season: "2025-26", points: 160.7 }], currentSeason: { season: "2025-26", topRate: 33, avoid4th: 76, bestScore: 55300 }, videos: [
  ...
  { id: "miura", name: "三浦智博", nameEn: "Tomohiro Miura", org: "JPML", title: "十段位×2", tags: ["A1"], league: "A1", period: "第28期", joinYear: 2012, birthday: "1987/04/26", gender: "male", href: "/players/miura", mleagueTeam: "EARTH JETS", birthplace: "愛知県小牧市", hobby: "麻雀研究", nickname: "変幻自在の感覚派", titles: [{ year: "2024", name: "第41期十段位" }, { year: "2023", name: "第40期十段位" }, { year: "2023", name: "第48期王位" }], bio: ["「実戦5万半荘の感覚派」三浦智博。愛知県小牧市出身、1987年生まれ。名古屋工業大学中退後、2012年に日本プロ麻雀連盟第28期生としてプロ入り。", "プロ入り11年目となる2023年、第40期十段位で初タイトルを獲得。翌2023年に第48期王位、2024年には十段位を連覇（第41期）と、30代後半でついに覚醒。Mリーグには2025-26シーズンよりEARTH JETSメンバーとして参加。", "連盟公式ルールで鍛えられた打点力に自信を持つ攻撃型。5万半荘以上の実戦経験から磨かれた感覚打ちで対戦相手を圧倒する。"], annualPoints: [{ season: "2025-26", points: -381.9 }], currentSeason: { season: "2025-26", topRate: 11, avoid4th: 62, bestScore: 70900 }, videos: [
  ...
  { id: "aikawa", name: "逢川恵夢", nameEn: "Megumu Aikawa", org: "NPM", title: "永世女流雀王", tags: ["女流", "A1"], league: "B2", period: "第1期", joinYear: 2002, birthday: "1987/08/28", gender: "female", href: "/players/aikawa", mleagueTeam: "EARTH JETS", birthplace: "大阪府", hobby: "麻雀研究", nickname: "黒髪のイシュタル", titles: [{ year: "2025", name: "第25期女流名人" }, { year: "2025", name: "第23期女流雀王（永世位達成）" }, { year: "2024", name: "第22期女流雀王" }, { year: "2022", name: "第20期女流雀王" }, { year: "2020", name: "第18期女流雀王" }, { year: "2019", name: "第17期女流雀王" }], bio: ["「永世女流雀王」逢川恵夢。大阪府出身、1987年生まれ。2002年、令和元年生まれを自称（本人談）。2011年に日本プロ麻雀協会に入会、第10期新人王戦を優勝してプロデビュー。", "女流雀王のタイトルを通算10期以上獲得し、永世女流雀王の称号を持つ唯一の雀士。2023年には第18期女流雀王で最後のタイトルを獲得し永世称号を確定させた。Mリーグには2025-26シーズンよりEARTH JETSメンバーとして参加。", "軽快な鳴き麻雀と柔軟な手組みが持ち味。長野市出身で「令和元年生まれ」というキャラクター設定も愛されている。"], annualPoints: [{ season: "2025-26", points: -114.3 }], currentSeason: { season: "2025-26", topRate: 11, avoid4th: 80, bestScore: 60000 }, videos: [
