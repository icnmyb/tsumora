...
export interface AnnualPoint {
  ...
  team?: MLeagueTeam;      // そのシーズンの所属。現所属がない/異なる退団・移籍選手は必ず指定
...
export interface RosterPlayer {
  ...
  joinYear?: number;
  proSinceYear?: number;
  debutOrgLabel?: string;
  careerNote?: string;
  careerTimeline?: { year: string; name: string; sub?: string }[];
  birthday?: string;
  gender?: Gender;
  href?: string;
  officialUrl?: string;
  mleagueTeam?: string;    // 現在のプロフィール表示用。過去成績の所属は annualPoints[].team を優先
  birthplace?: string;
  branch?: string;
  bloodType?: string;
  hobby?: string;
...
export const ALL_PLAYERS: AllPlayer[] = [
  ...
  { id: "suzuki-t", name: "鈴木たろう", nameEn: "Taro Suzuki", furigana: "すずき たろう", org: "最高位戦", title: "雀王×4", tags: ["A1"], league: "A1", period: "第45期後期", joinYear: 2020, proSinceYear: 1997, debutOrgLabel: "日本プロ麻雀棋士会", careerNote: "1997年に日本プロ麻雀棋士会でプロ入り。2005年に日本プロ麻雀協会へ移籍し、2020年11月に最高位戦へ移籍。", careerTimeline: [{ year: "2005", name: "日本プロ麻雀協会へ移籍", sub: "協会時代に雀王4期を獲得" }], birthday: "1973/10/04", gender: "male", href: "/players/suzuki-t", officialUrl: "https://saikouisen.com/members/suzuki-taro/", mleagueTeam: "赤坂ドリブンズ", birthplace: "茨城県", bloodType: "B型", hobby: "ポーカー・将棋", nickname: "ゼウスの選択", titles: [{"year":"2014","name":"第13期雀王"},{"year":"2013","name":"第12期雀王"},{"year":"2012","name":"第11期雀王"},{"year":"2010","name":"第9期雀王"}], bio: ["「ゼウスの選択」鈴木たろう。茨城県水海道市（現常総市）出身、1973年10月4日生まれ。1997年に日本プロ麻雀棋士会でプロ入りし、2005年に日本プロ麻雀協会へ移籍。2020年11月に最高位戦日本プロ麻雀協会へ移籍した。", "日本プロ麻雀協会時代に第9・11・12・13期雀王を獲得したタイトルホルダー。最高位戦では第45期後期入会で、現在はA1リーグに所属している。Mリーグには2018年の発足時から赤坂ドリブンズのメンバーとして参加している。", "趣味はポーカーと将棋。Mリーグ初年度に赤坂ドリブンズの優勝に貢献し、移籍後も最高位戦A1リーグとMリーグの両方で活動を続けている。"], annualPoints: [{ season: "2018-19", points: 30.1, note: "final" }, { season: "2019-20", points: -125.6 }, { season: "2020-21", points: 6.5, note: "final" }, { season: "2021-22", points: 132.0 }, { season: "2022-23", points: -327.3 }, { season: "2023-24", points: 211.2, note: "final" }, { season: "2024-25", points: 262.5, note: "final" }, { season: "2025-26", points: -334.9 }], currentSeason: { season: "2025-26", topRate: 10, avoid4th: 75, bestScore: 50100 }, videos: [
